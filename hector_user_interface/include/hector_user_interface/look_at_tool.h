...
#ifndef HECTOR_USER_INTERFACE_LOOK_AT_TOOL_H
#define HECTOR_USER_INTERFACE_LOOK_AT_TOOL_H
...
class LookAtTool : public rviz::InteractionTool {
Q_OBJECT
...
#endif  // HECTOR_USER_INTERFACE_LOOK_AT_TOOL_H
